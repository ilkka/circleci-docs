...
We have many versions of Android SDK pre-installed on [Ubuntu 12.04]({{ site.baseurl }}/build-image-precise/#android-sdk) and [Ubuntu 14.04]({{ site.baseurl }}/build-image-trusty/#android-sdk) build images.
